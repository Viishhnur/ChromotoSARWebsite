...
function CropClassifyVit() {
  ...
  const handleClassification = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch('http://18.232.96.25:80/vit-api/predictVit', {
        method: 'POST',
        headers: {
        ...
        <div className="bg-white rounded-xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">
              Crop Classification with ViT
            </h1>
            <p className="mt-2 text-gray-600">
              Upload a crop image to classify it using Vision Transformer
            </p>
...
export default CropClassifyVit;   